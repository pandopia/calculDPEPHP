...
final class EndToEndTest extends TestCase
{
    ...
    public function testExempleEnrichiCorrespondAuVerif(string $inputPath, string $verifPath, array $tagsExcluded = []): void
    {
        ...
        $pipeline->add(new \CalculDpe\Chauffage\Strategy\MultiGenerateurs());
        $pipeline->add(new \CalculDpe\Chauffage\Strategy\InsertPoeleAppoint());
        $pipeline->add(new \CalculDpe\Chauffage\Strategy\InsertElecSdb());
        $pipeline->add(new \CalculDpe\Chauffage\Strategy\AppointInsertElecSdb());
        $pipeline->add(new \CalculDpe\Chauffage\Strategy\ChaudiereReleve());
        $pipeline->add(new \CalculDpe\Chauffage\Strategy\ConvecteurBijonction());
        $pipeline->add(new \CalculDpe\Chauffage\Strategy\ChauffageSolaire());
        $pipeline->add(new \CalculDpe\Chauffage\Strategy\SolaireInsertPoele());
